...
@api.post("/api/kategorier/skrapa")
...
@api.get("/api/bocker/<string:kategori_slug>")
def api_hamta_bocker(kategori_slug: str):

    """
    Returnerar böcker i en kategori.
    Om dagens fil finns används den annars skrapas nya böcker.
    """
...
@api.post("/api/bocker/<string:kategori_slug>")
def api_skapa_bok(kategori_slug: str):

    """
    Skapar en bok manuellt.
...
@api.put("/api/bocker/<string:kategori_slug>/<string:bok_id>")
...
@api.delete("/api/bocker/<string:kategori_slug>/<string:bok_id>")
def api_ta_bort_bok(kategori_slug: str, bok_id: str):

    """
    Tar bort en bok från dagens JSON-fil
    """
    ...
    try:
        ...
        payload["bocker"] = [
            b for b in payload["bocker"] if b.get("id") != bok_id
        ]
