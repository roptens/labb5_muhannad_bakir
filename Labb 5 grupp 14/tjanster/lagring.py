...
#Hämtar projektets huvudmapp så data alltid sparas på rätt plats
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))

#Sätter data mappen i projektets root
DATA_MAPP = os.path.join(BASE_DIR, "data")
...
def skriv_json(filvag: str, data):
    ...
    sakerstall_data_mapp()  #säkerställer att data mappen finns
...
def bocker_filvag(kategori_slug: str):
